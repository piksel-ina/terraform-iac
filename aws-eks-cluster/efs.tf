...
# Rules are standalone aws_security_group_rule resources, not inline, so other
# roots (e.g. the admin workstation) can attach ingress to this SG without the
# inline ruleset reverting them on apply. Do not add inline ingress/egress here.
